...
void handle_gear_data(uint8_t *data, uint8_t len) {
    ...
    clcd_putch(data[0], (0xC0 + (5)));
}

void handle_rpm_data(uint8_t *data, uint8_t len) {

    data[len] = '\0';
    clcd_print(data, (0xC0 + (7)));
}
...
void process_canbus_data() {
    ...
    if (len) {
        switch (msg_id) {
            case 0x10: handle_speed_data(data, len);
                break;
            case 0x20: handle_gear_data(data, len);
                break;
            case 0x30: handle_rpm_data(data, len);
                break;
            case 0x50: handle_indicator_data(data, len);
                break;
        }
    }
}
